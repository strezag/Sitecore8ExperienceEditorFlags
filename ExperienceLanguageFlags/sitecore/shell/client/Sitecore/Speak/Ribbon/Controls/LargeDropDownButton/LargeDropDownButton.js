define(["sitecore", "/-/speak/v1/ExperienceEditor/RibbonPageCode.js"], function (Sitecore) {
    Sitecore.Factories.createBaseComponent({
        ...
        initialize: function () {
            ...
            /// Forcing showIcon(bool) value as true
            this.model.set("showIcon", '1');
        ...
        /// Drop down list, full pop up HTML
        renderDropDownItems: function (dropDownItemsList) {
            ...
            for (var i = 0; i < dropDownItemsList.length; i++) {
                ...
                //* Adding languageIso and setting LanguageCode value 
                var languageIso = dropDownItemsList[i].LanguageCode;
                ...
                /// Create an image element for the IconPath
                ...
                /// span tag to hold languageIso label
                var span2 = window.parent.document.createElement("span");
                span2.innerHTML = languageIso;
                span2.setAttribute("class", "sc_DropDownItemText");
